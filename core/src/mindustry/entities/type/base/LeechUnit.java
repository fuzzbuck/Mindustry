...
public class LeechUnit extends BaseUnit{
    ...
    attack = new UnitState(){
        ...
        public void update(){
            Tile powerLine = getClosestEnemyPowerNode();
        ...
        if(!Units.invalidateTarget(target, this)){
            if(dst(target) < getWeapon().bullet.range()){
                ...
                if(Angles.near(angleTo(target), rotation, 13f)){
                    ...
                    Vec2 to = Predict.intercept(LeechUnit.this, target, ammo.speed);

                    getWeapon().update(LeechUnit.this, to.x, to.y);
                }
            }
        }
    }
