...
public class OLDMinerDrone extends BaseDrone implements MinerTrait{
    ...
    mine = new UnitState(){
        ...
        public void update(){
            ...
            if(targetItem != null && entity.block.acceptStack(targetItem, 1, entity.tile, OLDMinerDrone.this) == 0){
                OLDMinerDrone.this.clearItem();
                return;
            }
    ...
    drop = new UnitState(){
        ...
        public void update(){
            ...
            if(dst(target) < type.range){
                if(tile.tile.block().acceptStack(item.item, item.amount, tile.tile, OLDMinerDrone.this) > 0){
