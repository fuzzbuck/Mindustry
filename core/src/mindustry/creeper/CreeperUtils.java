...
public class CreeperUtils {
    ...
    public static void init(){
        ...
        Timer.schedule(() -> Call.infoPopup("\uE810 [" + getTrafficlightColor(Core.graphics.getFramesPerSecond() / 60) + "]" + Core.graphics.getFramesPerSecond() + "/60[] ticks per second", 1f, 20, 50, 20, 500, 0), 0, 1);
